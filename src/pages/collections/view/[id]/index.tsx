...
import { getCollectionById } from 'apiSdk/collections';
...
function CollectionViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CollectionInterface>(
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('collection', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/collections/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Creation Date"
                  text={
                    data?.creation_date ? format(parseISO(data?.creation_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
                ...
                <FormListItem label="Total Songs" text={data?.total_songs} />
