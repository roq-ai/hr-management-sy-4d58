...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Artists', path: '/artists', entity: 'artist', service: AccessServiceEnum.PROJECT, icon: FiMic },
    {
      name: 'Collections',
      path: '/collections',
      entity: 'collection',
    ...
    { name: 'Songs', path: '/songs', entity: 'song', service: AccessServiceEnum.PROJECT, icon: FiFileText },
